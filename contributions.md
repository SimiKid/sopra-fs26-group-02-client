...
|                    | 17.04.2026   | [Link to Commit 2](https://github.com/SimiKid/sopra-fs26-group-02-server/commit/5a8072e30d00878e737195967e0ee9b27c22599e) | Add wizard to battle UI and redesign battle UI|
|                    | 19.04.2026   | [Link to Commit 3](https://github.com/SimiKid/sopra-fs26-group-02-client/commit/65308f723a6e33139e48de28f69858d5a3b66c81) | Add @service annotation to BattleService so Spring registers it, Save player before ready check to fix CONFIGURING→BATTLE transition, Broadcast initial BattleStateDTO when both players are ready, Add GameSubscriptionListener to re-send state on client subscribe, Add BattleService.getCurrentState() for on-subscribe lookup | Provides essential backend infrastructure for real-time multiplayer battles, enables frontend battle UI functionality.|
